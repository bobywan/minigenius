...
export const PREHISTOIRE_BANK: QuizSeed[] = [
  ...
  },
  {
    ...
    distractors: [
      "on y a vécu longtemps",
      "on y a trouvé des outils",
      "on y a enterré des morts",
    ],
  },
  {
