      ...
      {KEYS.map((key) => {
        ...
        return (
          <motion.button
            ...
            className={[
              "rounded-[var(--radius-btn)] font-display font-bold text-2xl",
              ...
              isValidate
                ...
                : isDelete
                  ...
                  : "bg-bg-card text-neutral-100 border-2 border-white/20 shadow-[var(--shadow-btn)] hover:bg-bg-card-hover",
            ].join(" ")}
          >
            {key}
          </motion.button>
